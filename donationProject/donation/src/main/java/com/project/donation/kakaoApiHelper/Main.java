package com.project.donation.kakaoApiHelper;
...
public class Main {
    ...
    private static KakaoApiHelper apiHelper = new KakaoApiHelper();
    ...
    public void test() {
        // access token 지정
        apiHelper.setAccessToken("a099fdcbfae95ecd3b96b2a6f4ea1856");

        // 푸시 알림이나 유저 아이디 리스트가 필요할 때 설정 합니다. 
        // (디벨로퍼스 내에 앱설정 메뉴를 가시면 있습니다)
        apiHelper.setAdminKey("9424777d47d501f352aba20069badf10");
